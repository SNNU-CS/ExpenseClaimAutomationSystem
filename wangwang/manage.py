...
def main():
    if ENV is None:
        raise EnvironmentError("Couldn't get 'ENV' environment variable.Are you sure"
    ...
    if ENV in ['dev', 'test', 'pro']:
        os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'wangwang.settings.' + ENV)
    else:
        raise EnvironmentError("You have used an invalid ENV variable!"
